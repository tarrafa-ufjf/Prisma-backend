...
def build_tutors_general_rankings(kind: str = "best-performance", limit: int = 10):
    ...
    try:
        ...
        data = analyzer.tutors_rankings_general_analysis(version=version, connector=connector, kind=kind, limit=limit)
        return data
    finally:
        try:
            connector.close()
