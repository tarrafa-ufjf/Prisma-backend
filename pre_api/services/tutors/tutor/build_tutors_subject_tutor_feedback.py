...
def build_tutors_subject_tutor_feedback(subject_id: int, tutor_id: int):
    ...
    try:
        ...
        data = analyzer.feedback_analysis(subject_id, 'user', 'feedback', version, connector, tutor_id)
        return data
    finally:
        try:
            connector.close()
