...
class TutorAnalyzer:
    ...
    def analysis_response_foruns(self, subject_id, type_query, version, connector, start_at, end_at, tutor_ids, user_id=None):
        ...
        if type_query == "subject":
            return forums_response.subject_analysis(subject_id, version, connector, start_at, end_at, tutor_ids)
        raise ValueError("invalid type_query")
    
    def analysis_login(self, subject_id, type_query, version, connector, start_at, end_at, tutor_ids, user_id=None):
    ...
    def analysis_feedback(self, subject_id, type_query, version, connector, start_at, end_at, tutor_ids, user_id=None):
