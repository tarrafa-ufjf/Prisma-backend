...
def build_tutors_subject_tutor_indicators(subject_id: int, student_id: int):
    ...
    try:
        ...
        data = analyzer.tutor_indicators_analysis(subject_id, 'user', 'indicators', version, connector, student_id)
        return data
    finally:
        try:
            connector.close()
